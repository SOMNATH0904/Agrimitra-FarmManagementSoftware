  ...
  return (
    ...
    <section className="settings-section mb-8">
      ...
      <div className="setting mb-4">
        <label for="farmName" className="block mb-1">Farm Name:</label>
        <input type="text" id="farmName" name="farmName" className="w-full px-4 py-2 border rounded-md border-gray-300"/>
      </div>
      <div className="setting mb-4">
